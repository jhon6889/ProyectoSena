  ...
  public function login() {
      if (isset($_POST["loginAdminEmail"])) {
          ...
          if (preg_match('/^[.a-zA-Z0-9_]+([.][.a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["loginAdminEmail"])) {
              ...
              // valido respuesta cuando el status es 200 (inicio de sesión exitoso)
              if ($login->status == 200) {
                  ...
                  echo '<script>
                    ...
                    //   // Muestra el mensaje de éxito
                      fncToastr("success", "Inicio de sesión exitoso");
                  ...
                  if ($login->results == "Wrong email") {
                      $error = "Escribiste mal el correo";
                  } else {
              ...
              // Manejar errores de formato del correo electrónico
              echo '<div class="alert alert-danger mt-4">Error de sintaxis en el correo</div>
              <script>
                  fncToastr("error", "Error de sintaxis en el correo");
                  fncMatPreloader("off");
                  fncFormatInputs();
              </script>';
          }
