    ...
    <div class="card-body">
      ...
      <form  method="post" class="needs-validation" novalidate>
        ...
        <div class="input-group mb-3">
          ...
          <div class="invalid-feedback">ingresa bien los datos.</div>
        </div>
      ...
      <!-- /.social-auth-links -->
      <p class="mb-1">
        <a href="#resetPassword" data-bs-toggle="modal">RECUERDA LA CONTRASEÑA</a>
      </p>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Perdiste la contraseña Eres invecil o que ? </h4>
      ...
      <div class="modal-body">
       ...
       <p class="login-box-msg">Si eres invecil y perdistes la contraseña dale click Aqui y recuperala </p>
