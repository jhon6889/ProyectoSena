					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-12 col-lg-6 text-center text-lg-left">
								...
								<h4 class="mt-3">Agregar categoria</h4>
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<div class="form-group pb-3"> 
										...
										<label for="name_category">titulo <sup class="text-danger font-weight-bold">*</sup></label>
						...
						<div class="col">
							...
							<div class="card">
								...
								<div class="card-body col-md-6 offset-md-3">
									<h2>trabajando en matadatos vzor</h2>
									<!--=====================================
									Visor metadatos
									======================================-->
<!-- 
