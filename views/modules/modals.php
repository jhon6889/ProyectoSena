...
<div class="modal" id="register">
  ...
  <div class="modal-dialog modal-md modal-dialog-centered">
    ...
    <div class="modal-content">
      ...
      <!-- Modal Header -->
      <div 
      class="modal-header  text-uppercase"
...
<!-- 
        ...
        <form method="post" class="needs-validation" novalidate>
          ...
          <button class="btn btn-block bg-default ">Crear Cuenta</button>   
...
<!--             
        ...
        <form method="post" class="needs-validation" novalidate>
          ...
          <button class="btn btn-block bg-default ">Ingresar</button> 
...
<!--=====================================
MODAL reset passsword AL SISTEMA
======================================-->
<!-- The Modal -->
