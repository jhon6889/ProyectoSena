           ...
           // echo '<pre>'; print_r( $data); echo '</pre>';
            ...
            $dataJson = '{
                ...
                foreach ($data as $key => $value) {
                    ...
                    $keywords_category = ""; // revisar aqui por que esta vacia la variable
                    $keywordsArray = explode(",",$value->keywords_category);
                    foreach ($keywordsArray as $index => $item) {
                        $keywords_category.= "<span class='badge badge-primary border rounded-pill px-3 py-1'>".$item."</span> ";
                    }
                    ...
                    $actions = "<div class='btn-group'>
                                    ...
                                    table='categories' column='category' idItem='".base64_encode($value->id_category)."'>
