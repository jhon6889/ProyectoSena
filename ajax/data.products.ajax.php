...
class DatatableController{
	...
	public function data(){
		...
		if(!empty($_POST)){
            ...
            $select = "id_product,name_product,url_product,image_product,description_product,keywords_product,name_category,name_subcategory,views_product,status_product,date_updated_product";
            ...
            if(!empty($_POST['search']['value'])){	
	            ...
	            $url = "relations?rel=products,subcategories,categories&type=product,subcategory,category&select="
